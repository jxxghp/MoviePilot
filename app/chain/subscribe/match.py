...
class SubscribeMatchOwner(_SubscribeOwnerBase):
            ...
            for context in contexts:
                ...
                if (
                    ...
                    if re_mediainfo:
                        ...
                        context.match_source = self._SubscribeChain__get_media_id_match_source(re_mediainfo)
                    ...
                    for domain, contexts in processed_torrents.items():
                        ...
                        for context in contexts:
                            ...
                            if custom_words_list:
                                ...
                                if apply_words:
                                    ...
                                    if torrent_mediainfo:
                                        ...
                                        _context.match_source = self._SubscribeChain__get_media_id_match_source(
                                            torrent_mediainfo
                                        )
                            ...
                            if not torrent_mediainfo or not resolve_media_identity(media=torrent_mediainfo)[1]:
                                ...
                                if not self._SubscribeChain__is_title_match_allowed(
                                    mediainfo=mediainfo,
    ...
    @staticmethod
    def _SubscribeChain__is_title_match_allowed(
        mediainfo: MediaInfo,
