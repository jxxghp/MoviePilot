...
class TransferQueueOwner(_TransferOwnerBase):
    ...
    def _TransferChain__build_replay_kwargs(
        ...
        return {
            ...
            "music_release_regions": options.get("music_release_regions"),
            "music_release_scripts": options.get("music_release_scripts"),
            "background": True,
    ...
    def _TransferChain__queue_accepted_replay(
        ...
        task = TransferTask(
            ...
            transfer_batch_id=options.get("transfer_batch_id"),
            transfer_batch_title=options.get("transfer_batch_title"),
            transfer_batch_root=options.get("transfer_batch_root"),
            transfer_batch_total=options.get("transfer_batch_total"),
            music_release_regions=replay_kwargs["music_release_regions"],
            music_release_scripts=replay_kwargs["music_release_scripts"],
