...
OPERATION_DESCRIPTIONS = {
    ...
    "plugin.loglevel.get": "List one plugin's instances, including the plugin itself, with each instance's configured and effective log level.",
...
FIELD_DESCRIPTIONS = {
    ...
    "expires_at": "Expiry timestamp for a plugin instance's log-level override; null means it never expires. A timestamp without a timezone is read as UTC.",
    ...
    "template": "Pass default to read the built-in media-classification policy template; omit it to read the active policy.",
