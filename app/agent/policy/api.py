...
API_EXTENDED_OPERATION_SPECS: tuple[ApiOperationSpec, ...] = (
    ...
    _user_write("subscription.search_all", effect=ActionEffect.EXTERNAL_SIDE_EFFECT),
    _spec(
    ...
    _write("plugin.folder.update", recovery=RecoveryMode.TRANSACTION),
...
API_OPERATION_ROUTES: dict[str, ApiOperationRoute] = {
    ...
    "subscription.search": ApiOperationRoute("POST", "/api/v1/subscribe/search/{subscribe_id}"),
    ...
    "plugin.reload": ApiOperationRoute("POST", "/api/v1/plugin/reload/{plugin_id}"),
    ...
    "subscription.reset": ApiOperationRoute("POST", "/api/v1/subscribe/reset/{subid}"),
    "subscription.search_all": ApiOperationRoute("POST", "/api/v1/subscribe/search"),
    "subscription.refresh": ApiOperationRoute("POST", "/api/v1/subscribe/refresh"),
    "subscription.metadata.refresh": ApiOperationRoute("POST", "/api/v1/subscribe/check"),
    ...
    "transfer.history.clear": ApiOperationRoute("DELETE", "/api/v1/history/transfer/all"),
    ...
    "plugin.folder.update": ApiOperationRoute("PATCH", "/api/v1/plugin/folders/{folder_name}"),
    ...
    "plugin.folder.plugin.assign": ApiOperationRoute(
        "PUT",
