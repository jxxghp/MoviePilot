...
def test_read_audio_metadata_maps_easy_tags(monkeypatch):
    ...
    monkeypatch.setattr("app.adapters.media.audio.MutagenFile", lambda *_args, **_kwargs: audio)
...
def test_read_audio_metadata_falls_back_to_filename(monkeypatch):
    ...
    monkeypatch.setattr("app.adapters.media.audio.MutagenFile", lambda *_args, **_kwargs: None)
