...
def test_set_plugin_instance_version_rejects_instance_outside_plugin(monkeypatch):
    ...
    overview = {
        ...
        "installed_versions": [],
        "instances": [{"instance_id": "OtherWork", "pinned_version": None, "running": False}],
    }
    calls: list = []
    manager = type(
        "Manager",
...
def test_set_plugin_instance_version_delegates_to_manager_and_reports_success(monkeypatch):
    ...
    overview = {
        ...
        "current_version": "1.0.0",
        "installed_versions": [],
        "instances": [{"instance_id": "DemoPluginWork", "pinned_version": "1.0.0", "running": True}],
    }
    calls: list = []

    def _set_version(self, instance_id, *, pinned_version=None):
