...
class TransferJobManagerTest(unittest.TestCase):
    ...
    def test_transfer_media_uses_target_folder_returned_by_storage(self):
        ...
        with patch.object(
                ...
                "app.application.transferhandler.DirectoryHelper.get_media_root_path",
                return_value=Path("/library"),
        ), patch.object(
                TransHandler,
                "_TransHandler__transfer_command",
                return_value=(target_item, ""),
        ), patch("app.application.transferhandler.eventmanager") as eventmanager_mock:
    ...
    def test_success_callback_uses_transfer_result_target_diritem(self):
        ...
        with patch(
            "app.application.orchestration.transfer.TransferHistoryOper", return_value=SimpleNamespace()
        ), patch(
    ...
    def test_manual_episode_offset_applies_once(self):
        ...
        with patch("app.application.orchestration.transfer.TransferHistoryOper", return_value=transfer_history_oper), \
                patch("app.application.orchestration.transfer.DownloadHistoryOper", return_value=download_history_oper), \
                patch("app.application.orchestration.transfer.get_configured_system_config", return_value=system_config_oper), \
                patch("app.application.orchestration.transfer.MetaInfoPath", lambda *args, **kwargs: FakeMeta(14)):
    ...
    def test_failed_history_is_retried_within_retry_budget(self):
        ...
        try:
            with patch(
                ...
                "app.application.orchestration.transfer.DownloadHistoryOper",
    ...
    def test_do_transfer_syncs_same_stem_extra_files_by_default(self):
        ...
        with patch(
            ...
            "app.application.orchestration.transfer.StorageChain",
    ...
    def test_do_transfer_skips_manual_single_file_when_epformat_misses(self):
        ...
        with patch(
            ...
            "app.application.orchestration.transfer.MetaInfoPath",
