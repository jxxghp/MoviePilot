...
| 32 线程 Python CPU 热点 | 12,062.9 ops/s | 38,340.8 ops/s | V3t 约为 3.18 倍，free-threaded 的主要收益成立。 |
| 32 线程 Rust 热点 | 37,620.2 ops/s | 47,225.7 ops/s | 两套镜像均使用 Rust，V3t 在该并发样本中仍有收益。 |
| 单线程 CPU 热点 | 基线 | 约慢 4.8% | 单线程成本存在但低于 25% 验收阈值，不能用并发收益掩盖后续扩大退化。 |
